...
Then move onto :doc:`Github` which is a reminder of how to use git.
...
I maintain the perspective that the best way to learn programming is to just go google it. When you get stuck go read through wpilib (https://github.com/wpilibsuite/allwpilib). 
Also go look at previous years code, dont be afraid to copy stuff to start with. 
